...
app.get('/info', (req, res) => {
	...
	const slackName = req.query.slack_name || 'Taslihah Thanni';
	...
	// Github URLs
	const githubUrlFile = 'https://github.com/Tess647/HNGx/blob/main/index.js';
	const githubUrlSource = 'https://github.com/Tess647/HNGx';
